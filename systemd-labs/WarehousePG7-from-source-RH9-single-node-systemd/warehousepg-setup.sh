...
# export COORDINATOR_DATA_DIRECTORY so gpstate/gpstart/gpstop work on interactive login
...
if ! grep -q "export COORDINATOR_DATA_DIRECTORY=" /home/${WHPG_USER}/.bashrc 2>/dev/null; then
    echo "export COORDINATOR_DATA_DIRECTORY=/whpgdata/coordinator/whpgsne-1" >> /home/${WHPG_USER}/.bashrc
fi
